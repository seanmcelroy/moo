    ...
    public static class ArrayReverse
    {
        public static ForthPrimativeResult Execute(ForthPrimativeParameters parameters)
        {
            ...
            */
            ...
            if (n1.Type != DatumType.Array || n1.Value is not ForthListArray la)
            ...
            var reversed = n1.UnwrapListArray().Reverse().ToArray();
            var reversedArray = new ForthListArray(reversed);
            parameters.Stack.Push(new ForthDatum(reversedArray));
