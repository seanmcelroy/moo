...
namespace moo.common.Scripting.ForthPrimatives
{
    public static class RandomMethods
    {
        ...
        private static readonly Random _tickRandom = new(Environment.TickCount);
        ...
        public static ForthPrimativeResult GetSeed(ForthPrimativeParameters parameters)
        {
            ...
            */
            GetSeededRandom(); // Create seed if it doesn't exist.
        ...
        internal static int Random(int minValue, int maxValue) => _tickRandom.Next(minValue, maxValue);
    }
}