...
public class ForthExecutionContext
{
    ...
    public async Task<ForthProgramResult> RunAsync(object[] args, CancellationToken cancellationToken)
    {
                        ...
                        case "popn":
                            {
                                ...
                                if (si.Type != DatumType.Integer)
                                    return new ForthProgramResult(ForthProgramErrorResult.TYPE_MISMATCH, "POPN requires the top paramter on the stack to be an integer");
                        ...
                        case "dupn":
                            {
                                ...
                                var si = stack.Pop();
                                if (si.Type != DatumType.Integer)
                                    return new ForthProgramResult(ForthProgramErrorResult.TYPE_MISMATCH, "DUPN requires the top paramter on the stack to be an integer");
        ...
        return new ForthProgramResult(null);
    }
}